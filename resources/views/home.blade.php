                ...
                <div class="container-fluid">
                    <div class="menu-wrapper d-flex align-items-center justify-content-between">
                        <div class="header-left d-flex align-items-center">
                            <!-- Logo -->
                            <div class="logo">
                                <a href="{{url('welcome')}}"><img src="assets/img/logo/logo.png" alt=""></a>
                            </div>
                            <!-- Main-menu -->
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="{{url('shop')}}">Explore</a></li>
                                        ...
                                        <li><a href="{{url('blog')}}">Blog</a>
                                            <ul class="submenu">
                                                ...
                                                <li><a href="{{url('product_details_thumbnail')}}">Product Details 2</a></li>
                                            </ul>
                                        </li>
