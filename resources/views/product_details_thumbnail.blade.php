                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="directory-cap mb-40">
                          <h1>Thumbnails</h1>
                            <p>A thumbnail image is a small image that represents a larger one. Thumbnails are often used to provide snapshots of several images in a single space. They are commonly used by digital photo organization programs as well as visual search engines.
...
The term "thumbnail" was originally used to describe physical images or drawings that were miniature in size (roughly the size of a human thumbnail). However, it is now widely used to describe digital images, which are displayed on a screen. Digital thumbnails are usually between 75x75 and 200x200 pixels in size. They can also have a rectangular aspect ratio, such as 150x100 pixels.</p>
                        ...
                        <div class="gallery-img">
                            <div class="row">
                                <div class="col-lg-6">
                                    <img src="assets/img/gallery/tn/gallery1.png" class="mb-30" alt="">
                                </div>
                                <div class="col-lg-6">
                                    <img src="assets/img/gallery/tn/gallery2.png" class="mb-30" alt="">
                                </div>
                                <div class="col-lg-6">
                                    <img src="assets/img/gallery/tn/gallery3.png"  class="mb-30"alt="">
                                </div>
                                <div class="col-lg-6">
                                    <img src="assets/img/gallery/tn/gallery4.png"  class="mb-30"alt="">
                                </div>
                            </div>
                        </div>
                    </div>
