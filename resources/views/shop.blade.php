            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-8 ">
                    ...
                    <div class="new-arrival new-arrival2">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div class="single-new-arrival mb-50 text-center">
                                    ...
                                    <div class="popular-caption">
                                     <h3><a href="{{url('product_details')}}"> Brouchers</a></h3>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="single-new-arrival mb-50 text-center">
                                ...
                                <div class="popular-caption">
                                 <h3><a href="{{url('product_details_thumbnail')}}"> Thumbnails</a></h3>
                                 <div class="rating mb-10">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-new-arrival mb-50 text-center">
                            ...
                            <div class="popular-caption">
                             <h3><a href="product_details.html"> Business Cards</a></h3>
                             <div class="rating mb-10">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                ...
                <div class="col-xl43 col-lg-4 col-md-6 col-sm-6">
                    <div class="single-new-arrival mb-50 text-center">
                        ...
                        <div class="popular-caption">
                         <h3><a href="product_details.html"> Stationary Item</a></h3>
                         <div class="rating mb-10">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
